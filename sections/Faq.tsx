...
const faqs = [
  ...
  },
  {
    ...
    a: "O pacote contempla o tempo de pista (até 1 hora), o uso do kart da categoria escolhida e o acompanhamento de instrutor habilitado, além da orientação sobre traçado e pilotagem. Itens como macacão, luva e sapatilha são inclusos.",
  },
  {
          ...
          <div className="lg:col-span-5">
            <div className="faqs-content">
              <div className="section-title">
                ...
                <p>
                  Tire suas dúvidas sobre aulas, aluguel de kart, categorias e
                  como funciona o dia na pista com a Gurgel Team.
                </p>
              </div>
            </div>
          </div>
