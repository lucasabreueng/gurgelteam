      ...
      <div className="flex gap-4 p-4 md:p-5">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-[10px] font-bold uppercase tracking-wider text-white/50">
            Operação Gurgel Team
          </p>
          <h2 className="text-2xl font-black tracking-tight">
            {operational.name}
          </h2>
          <p className="mt-1 text-sm text-white/75">{operational.specialty}</p>
          <dl className="mt-4 grid grid-cols-2 gap-3 text-xs">
            <div className="rounded-lg bg-white/10 px-3 py-2 ring-1 ring-white/10">
              ...
              <dd className="mt-0.5 text-lg font-bold tabular-nums">
                {operational.dayOccupancy}%
              </dd>
            </div>
            <div className="rounded-lg bg-white/10 px-3 py-2 ring-1 ring-white/10">
              <dt className="text-white/45">Status</dt>
              <dd className="mt-0.5 font-bold">
                {operational.operationalStatusLabel}
              </dd>
            </div>
          </dl>
        </div>
