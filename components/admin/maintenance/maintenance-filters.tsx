...
export function MaintenanceFilters({ filters, onChange, onClear }: Props) {
  ...
  return (
    <FilterBox active={active} onClear={onClear}>
      <div className="flex flex-col gap-4 lg:flex-row lg:items-stretch">
        ...
        <div className="admin-page-grid grid min-w-0 flex-1 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
          <div className={cell}>
            <SettingsDropdown
