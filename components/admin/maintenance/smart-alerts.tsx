...
import type { MaintenanceAlert } from "@/lib/contracts/maintenance";

export function SmartAlerts({ alerts }: { alerts: MaintenanceAlert[] }) {
  return (
    <section className="rounded-2xl border border-[rgba(17,17,17,0.08)] bg-white p-5 shadow-sm md:p-6">
      <h3 className="text-lg font-bold text-[#0d1f3c]">Alertas inteligentes</h3>
