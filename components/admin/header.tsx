...
export function Header() {
  const operationStatus = DashboardServiceMock.getOperationStatus();
    ...
    <header className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 lg:justify-end">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="flex h-11 w-11 items-center justify-center rounded-xl border border-[rgba(17,17,17,0.08)] bg-white text-[#0d1f3c] transition hover:border-accent/25"
